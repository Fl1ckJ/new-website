/* SteelTrace forms — Weekly product demo (Mautic form 12).
   Uses the SAME shared engine as the working newsletter/contact forms
   (window.STMautic.wire) — only the fields differ. Auto-generates the next
   6 Thursday slots (alternating 09:00 / 16:00). Trigger: [data-weekly-open].
   Call window.STForms.weekly() once to mount. */
(function () {
  "use strict";
