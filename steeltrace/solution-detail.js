(function () {
  ...
  function siblings() {
    ...
    return '<div class="sib-grid">' + sibs.map(function (x) {
      return '<button class="sib" type="button" onclick="location.href=\'solution-' + x.id + '.html\'"><span class="c">' + e(x.code) + '</span><b>' + e(x.name) + '</b></button>';
    }).join("") + '</div>';
  }
      ...
      '<div class="tz">' +
        ...
        '<div class="tz-body">' +
          '<div class="tz-copy">' +
            ...
            '<div class="row"><a class="btn btn-ghost" href="Trust.html">How SteelTrace proves a record <span class="ar">→</span></a></div>' +
          '</div>' +
      ...
      '<div class="tz">' +
        ...
        '<div class="tz-body">' +
          '<div class="tz-copy">' +
            ...
            '<div class="row"><a class="btn btn-ghost" href="Product.html">Explore the product <span class="ar">→</span></a></div>' +
          '</div>' +
          '<div class="tz-viz" aria-hidden="true">' +
  ...
  el.innerHTML =
    ...
    '<div class="d-cta">' +
      ...
      '<div class="row"><a class="btn btn-primary" href="demo.html">Book a demo <span class="ar">→</span></a><a class="btn btn-ghost" href="How%20It%20Works.html">How it works</a></div>' +
    '</div>') +

    teasers;

  (function(){ var pg = el.closest ? el.closest('.page') : el.parentNode; if(pg && !pg.querySelector('.crumbs')){ var n=document.createElement('nav'); n.className='crumbs'; n.setAttribute('aria-label','Breadcrumb'); n.innerHTML='<a href="SteelTrace%20Home.html">Home</a><span class="sep">/</span><span class="cur">Solutions</span><span class="sep">/</span><span class="cur">'+e(sol.name)+'</span>'; pg.insertBefore(n, pg.firstChild); } })();
  window.scrollTo(0, 0);
